...
export const RecognitionDetails: React.FC<ViewRecognitionProps> = ({ route }) => {
    const navigation = useNavigation<NavigationProp<RootStackParamList, "RecognitionDetails">>();
        ...
        <Layout showCredits={false}>
            <VStack flex={1} px={5} py={6} space={4}>
                ...
                <HStack alignItems="center" space={4}>
                    <Avatar size="48px" source={recognition.userSource.picture ? { uri: recognition.userSource.picture } : avatarImage} />
                    <VStack>
