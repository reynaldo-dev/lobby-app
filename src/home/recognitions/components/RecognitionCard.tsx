                ...
                >
                    <HStack space={4}>
                        <VStack space={2} alignItems="center" maxW={"40%"}>
                            <Text fontWeight="bold" fontSize={"16"} textTransform={"capitalize"}>{firstName} {firstLastName}</Text>
                            <Image
                                source={imageSource}
                                ...
                                borderRadius="full"
                            />
                            <Box mt={2} backgroundColor="#cd7f32" px={2} py={1} borderRadius="sm" w={"100%"}>
                                <Text fontSize={"16"} fontWeight="bold" color="white" textAlign={"center"}>Bronce</Text>
                            </Box>
                        </VStack>
                        ...
                        <VStack flex={1}>
                            <Box flexGrow={1} justifyContent="center" alignItems="center">
                                <VStack alignItems="center">
                                    <Text fontWeight="bold" fontSize="2xl">Haz acumulado</Text>
                                    <HStack space={2} alignItems="center">
                                        <Text fontWeight="bold" fontSize="3xl">3</Text>
                                        <Icon
                                            as={AntDesign}
                                            name="star"
                                            size={8}
                                    ...
                                    <Text fontWeight="bold" fontSize="2xl">reconocimientos</Text>
                                </VStack>
                            </Box>
