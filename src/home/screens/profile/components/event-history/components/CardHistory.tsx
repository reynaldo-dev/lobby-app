...
export const CardHistory = ({ event }: EventCardProps) => {
    const { title, description, dateTime, link, eventCategory, AssistanceTicket } = event;
    const wasPresent = Array.isArray(AssistanceTicket) && AssistanceTicket.some(ticket => ticket.wasPresent);
