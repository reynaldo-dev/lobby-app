...
} from '../../redux/services/challenges.service';
...
export const ChallengeDetailScreen = () => {
     ...
     const {
          data: amIOnChallengeData,
          isLoading: amIOnChallengeLoading,
          refetch: refetchAmIOnChallenge,
     } = useAmIOnChallengeQuery({
     ...
     const handleEnroll = async () => {
          ...
          try {
               const response = await takeChallenge({
                    challengeId,
                    takeChallengeDto,
               });
               onClose();
     ...
     const getChallengeDateFormatted = (date: string) => {
          ...
          const month = dateObject.toLocaleDateString('es-ES', {
               month: 'long',
          });
          const year = dateObject.toLocaleDateString('es-ES', {
               year: 'numeric',
          });
