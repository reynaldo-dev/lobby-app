...
import { useGetAlliancesQuery } from '../../redux/services/alliances.service';
...
export const Alliances = () => {
     const navigation =
          useNavigation<NavigationProp<RootStackParamList, 'Alliances'>>();
     const {
          data: alliances,
          isLoading,
          isError,
     ...
     const categories = React.useMemo(() => {
          const cats = alliances
               ? [...new Set(alliances.map((a) => a.allianceCategory.name))]
               : [];
          return ['Todas', ...cats];
     }, [alliances]);
